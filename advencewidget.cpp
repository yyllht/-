...
AdvenceWidget::AdvenceWidget(QWidget *parent) : AbstractWidget(parent)
{
    ...
    if(GlobalManager::night)GrassBackgroundPixmap = new QPixmap(":/surface/res/images/surface/Background_1.jpg");
    else GrassBackgroundPixmap = new QPixmap(":/surface/res/images/surface/NormalGrass.png");
...
void AdvenceWidget::SwitchMouseType(PlantType PLVal, int xVal, int yVal)
{
    ...
    case PlantType::SunFlower:
        if(GlobalManager::night)MousePixmap = new QPixmap(":/plant/res/images/plant/SunFlower/1.png");
        else MousePixmap = new QPixmap(":/plant/res/images/plant/SunFlower/0.png");
    ...
    case PlantType::Peashooter:
        MousePixmap = new QPixmap(":/plant/res/images/plant/Peashooter/0.png");
    ...
    case PlantType::Repeater:
        MousePixmap = new QPixmap(":/plant/res/images/plant/Repeater/0.png");
        *MousePixmap = MousePixmap->scaled(ForScale(73), ForScale(71));
        MouseLabel->setPixmap(*MousePixmap);
        MouseLabel->setGeometry(xVal - ForScale(73 / 2), yVal - ForScale(71 / 2),
                                ForScale(73), ForScale(71));
        MouseLabel->show();
        MouseLabel->raise();
        break;
    case PlantType::WallNut:
        MousePixmap = new QPixmap(":/plant/res/images/plant/WallNut/0.png");
...
void AdvenceWidget::mouseMoveEvent(QMouseEvent *event)
{
    if(CurrentMainTimerStatus == MainTimerStatus::HasStarted)
    {
        ...
        case PlantType::Peashooter:
            ...
            break;
        case PlantType::Repeater:
            MouseLabel->move(event->x() - ForScale(73 / 2), event->y() - ForScale(71 / 2));
            MouseLabel->show();
            MouseLabel->raise();
            break;
        case PlantType::WallNut:
        ...
        if(MouseType != PlantType::NoPlant && MouseType != PlantType::Shovel)
        {
                    ...
                    && event->y() < ForScale(GlobalManager::PosY[5]))
            {
                ...
                if(ManagerManager::GlobalWarManager->grass[RowTemp - 1][CulumnTemp - 1] == nullptr)
                {
                    ...
                    {
                    case PlantType::SunFlower:
                        if(GlobalManager::night)VirtualPlantPixmap->load(":/plant/res/images/plant/SunFlower/1.png");
                        else VirtualPlantPixmap->load(":/plant/res/images/plant/SunFlower/0.png");
                        *VirtualPlantPixmap = VirtualPlantPixmap->scaled(ForScale(63), ForScale(72));
                        ...
                        break;
                    case PlantType::Peashooter:
                        VirtualPlantPixmap->load(":/plant/res/images/plant/Peashooter/0.png");
                    ...
                    case PlantType::Repeater:
                        VirtualPlantPixmap->load(":/plant/res/images/plant/Repeater/0.png");
                        *VirtualPlantPixmap = VirtualPlantPixmap->scaled(ForScale(73), ForScale(71));
                        VirtualPlant->setPixmap(*VirtualPlantPixmap);                        
                        VirtualPlant->setGraphicsEffect(m_GOE);
                        VirtualPlant->setGeometry(ForScale(GlobalManager::PosX[CulumnTemp] - 40 - 73 / 2), 
                    ...
                    case PlantType::WallNut:
                        VirtualPlantPixmap->load(":/plant/res/images/plant/WallNut/0.png");
...
{
    int posX = (CardID <= 4) ? (43 + CardID * 57) : (45 + CardID * 57);
    int posY = 10;
