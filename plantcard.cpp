...
PlantCard::PlantCard(PlantType TypeVal, int CardID, QObject *parent) : QObject(parent), CardType(TypeVal)
{
    ...
    case PlantType::SunFlower:
        FreezeMsec = 7500;
        if(GlobalManager::night){
            SunCost = 25;
            NormalPixmap = new QPixmap(":/card/res/images/card/Sunshroom.png");
        }
        else {
            SunCost = 50;
    ...
    case PlantType::Repeater:
        SunCost = 200;
        FreezeMsec = 7500;
        NormalPixmap = new QPixmap(":/card/res/images/card/Repeater.png");
        break;
    default:
        break;
    }
    
    PosX = (CardID <= 4) ? (43 + CardID * 57) : (45 + CardID * 57);
    PosY = 10;
