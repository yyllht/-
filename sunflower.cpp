...
SunFlower::SunFlower(int RowVal, int ColumnVal)
{
    ...
    if(GlobalManager::night)PlantMovie = new QMovie(":/plant/res/images/plant/SunFlower/SunShroom.gif");
    else PlantMovie = new QMovie(":/plant/res/images/plant/SunFlower/SunFlower1.gif");
